...
export default async function OpenPlotsProjectPage({
  params,
}: {
  ...
  const filteredPlots = openPlots.filter((p) => p.projectSlug === projectSlug)
    ...
    <main className="min-h-screen">
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-balance">
              {projectTitle} — Premium Open Plots
            </h1>
      ...
      <section id="plots" className="py-20">
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-balance">
              Available Open Plots {project ? `— ${projectTitle}` : ""}
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          {filteredPlots.length === 0 ? (
            <div className="max-w-2xl mx-auto text-center border rounded-2xl p-10">
              <h3 className="text-2xl font-bold mb-2">No open plots found</h3>
              <p className="text-muted-foreground mb-6">We don’t have open plot listings for this project yet.</p>
              <Button asChild>
                <Link href="/open-plots">Go Back</Link>
              </Button>
            </div>
          ) : (
